...
//      <<三国杀>>中有种叫做“闪电”的牌，是否被闪电击中 需要判定，如果是黑桃2~9的话， 会被闪电击中，然会掉3滴血。
//      假设有两个变量表示花色和点数，可以由键盘输入。
//      变量1的值 ：1~4 分别代表四种花色
//      变量2的值 ：1~13分别代表1~k
...
//        查找字符串中的空格数：例如："I love iOS, i want an iPhone5",,,有6个空格。。

//        int count = 0;
//        char str[40] = "I love iOS, i want an iPhone5";
