...
layout: post
title: iOS10 openURL
excerpt: "iOS10之后，出现了这个方法，- (void)openURL:(NSURL*)url options:(NSDictionary<NSString *, id> *)options completionHandler:(void (^ __nullable)(BOOL success))completion NS_AVAILABLE_IOS(10_0) NS_EXTENSION_UNAVAILABLE_IOS(""); "
categories: [Xcode]
tags: [Xcode, Tips]
date: 2016-10-03
comments: true
