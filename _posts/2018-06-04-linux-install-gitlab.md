...
[https://git-scm.com/book/zh/v1/起步-安装-Git](https://git-scm.com/book/zh/v1/起步-安装-Git)
...
清华软件源 [https://mirrors.tuna.tsinghua.edu.cn/gitlab-ce/yum/el6/](https://mirrors.tuna.tsinghua.edu.cn/gitlab-ce/yum/el6/)
...
nginx['listen_port'] = 10001 # override only if you use a reverse proxy:
```
...
external_url 'http://192.168.19.224'
...
nginx['listen_port'] = 10001 # override only if you use a reverse proxy: https://gitlab.com/gitlab-org/omnibus-gitlab/blob/master/doc/settings/nginx.md#setting-the-nginx-listen-port
...
# gitlab_ci['gitlab_ci_email_from'] = 'sakura_29@163.com'
# gitlab_ci['gitlab_ci_support_email'] = 'sakura_29@163.com'
...
# gitlab_ci['smtp_user_name'] = "sakura_29@163.com"
# gitlab_ci['smtp_password'] = "cywd20160508"
...
如果访问不了，请检查防火墙的端口是否开放

刚启动的时候访问有可能会出现502，过个半分钟1分钟就好了。



# 参考

[https://blog.csdn.net/ypjyangpeijun/article/details/20468043](https://blog.csdn.net/ypjyangpeijun/article/details/20468043)

[https://www.cnblogs.com/highsea90/p/5191340.html](https://www.cnblogs.com/highsea90/p/5191340.html)

[https://blog.csdn.net/wh211212/article/details/72627803](https://blog.csdn.net/wh211212/article/details/72627803)
